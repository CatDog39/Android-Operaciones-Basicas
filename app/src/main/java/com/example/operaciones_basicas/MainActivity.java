...
public class MainActivity extends AppCompatActivity {
    //Definicion objetos java equivalentes a los objetos xml programables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jetnumero2=findViewById(R.id.etnumro2);
    ...
    public void Calcular_operaciones(View view){
        ...
        if (numero1.isEmpty() || numero2.isEmpty()){
            Toast.makeText(this,"Los dos numeros son requeridos",Toast.LENGTH_SHORT).show();
